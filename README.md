...
## Introduction
The original archival sources, the digital processible data and the relevant literature refered to in publications can be considered the 'explicit knowledge' used to create new historical insights [Polanyi1966]. The representation of this knowledge is currently done using graph based data structures. The most prominent way of storing these graph based data structures is called the Resource Description Framework (RDF) [ref]. The data created by means of RDF is called a knowledge graph based on Linked Data.
